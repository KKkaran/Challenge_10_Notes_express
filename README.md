<h1 align='center'>Note Taker App<span><img src="icons/project.png" height="25" width="25"/></span></h1>
    ...
    <p><img src="icons/search.png" height="18" width="20"/>In this app, we can create new notes and they will be displayed on the left section. When clicked on them, all the information corresponding to them will be displayed in the main section. We can also delete a note by clicking on the bin icon to the left of the note.</p>
    <hr>
    ...
    <p><img src="icons/wheel.png" height="18" width="20"/>express path fs</p>
    <hr>
